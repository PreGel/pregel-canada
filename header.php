<!doctype html>
  ...
  <html class="no-js"  <?php language_attributes(); ?>>
	...
	<head>
        ...
        <link rel="alternate" href="https://pregelcanada.com/" hreflang="en-ca" />
		<?php wp_head(); ?>
		...
		<!-- <script>
		  ...
		  ga('create', 'UA-4623260-4', 'auto');
		  ga('send', 'pageview');

		</script> -->
		<!-- Global site tag (gtag.js) - Google Analytics -->
		<!-- <script async src="https://www.googletagmanager.com/gtag/js?id=UA-4623260-4"></script>
		<script>
		  window.dataLayer = window.dataLayer || [];
		  function gtag(){dataLayer.push(arguments);}
		  gtag('js', new Date());

		  gtag('config', 'UA-4623260-4');
		</script> -->
		<script>
			(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
			  (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
			  ...
			  ga('create', 'UA-4623260-4', 'auto', {'allowLinker': true});
			  ga('require', 'linker');
              ga('linker:autoLink', ['https://canada.pregel-itc.com/'] );
			  ga('send', 'pageview');
